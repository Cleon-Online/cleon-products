...
FROM maven:3.6.3-jdk-11 as cleon-products
WORKDIR /cleon-products
...
ARG DEPENDENCY=/cleon-products/target/dependency
COPY --from=cleon-products ${DEPENDENCY}/BOOT-INF/lib /app/lib
COPY --from=cleon-products ${DEPENDENCY}/META-INF /app/META-INF
COPY --from=cleon-products ${DEPENDENCY}/BOOT-INF/classes /app
##ENTRYPOINT ["sh", "-c", "java -jar /app.jar"]
ENTRYPOINT ["java","-cp","app:app/lib/*","com.cleon.products.CleonProductsApplication"]